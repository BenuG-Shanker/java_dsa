// class is about for implementing of the creation of the node, insertion of a new node, deletion of the existed node, and displaying of the node from the Singly Linked List i.e., sll
package LinkedList;
import java.util.*;
class sll{
